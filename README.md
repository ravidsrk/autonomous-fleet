...
pytest tests/                                      # full suite (73 files, 1576 tests; 100% line coverage of the Python tooling, scripts/*.py — shell is validated by behavioral + mutation tests, not line coverage)
...
├── tests/                               # 73 test files, 1576 tests; validators + engine doctrine + 4-layer substrate
