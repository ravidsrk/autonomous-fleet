...
<p align="center">
  ...
  <a href="https://github.com/ravidsrk/autonomous-fleet/releases"><img src="https://img.shields.io/badge/version-0.2.1-amber.svg?color=F59E0B" alt="Version 0.2.1"></a>
...
pytest tests/                                      # full suite (61 files, 1310 tests; 100% line coverage of the Python tooling, scripts/*.py — shell is validated by behavioral + mutation tests, not line coverage)
...
│   └── install-skills.sh
├── tests/                               # 61 test files, 1310 tests; validators + engine doctrine + 4-layer substrate
