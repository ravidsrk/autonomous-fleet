...
pytest tests/                                      # full suite (71 files, 1459 tests; 100% line coverage of the Python tooling, scripts/*.py — shell is validated by behavioral + mutation tests, not line coverage)
...
│   └── install-skills.sh
├── tests/                               # 71 test files, 1459 tests; validators + engine doctrine + 4-layer substrate
