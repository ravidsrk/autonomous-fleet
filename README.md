...
pytest tests/                                      # full suite (67 files, 1392 tests; 100% line coverage of the Python tooling, scripts/*.py — shell is validated by behavioral + mutation tests, not line coverage)
...
│   └── install-skills.sh
├── tests/                               # 67 test files, 1392 tests; validators + engine doctrine + 4-layer substrate
