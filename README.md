...
pytest tests/                                      # full suite (70 files, 1435 tests; 100% line coverage of the Python tooling, scripts/*.py — shell is validated by behavioral + mutation tests, not line coverage)
...
│   └── install-skills.sh
├── tests/                               # 70 test files, 1435 tests; validators + engine doctrine + 4-layer substrate
