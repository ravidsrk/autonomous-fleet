...
pytest tests/                                      # full suite (69 files, 1422 tests; 100% line coverage of the Python tooling, scripts/*.py — shell is validated by behavioral + mutation tests, not line coverage)
...
│   └── install-skills.sh
├── tests/                               # 69 test files, 1422 tests; validators + engine doctrine + 4-layer substrate
