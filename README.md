...
pytest tests/                                      # full suite (65 files, 1364 tests; 100% line coverage of the Python tooling, scripts/*.py — shell is validated by behavioral + mutation tests, not line coverage)
...
│   └── install-skills.sh
├── tests/                               # 65 test files, 1364 tests; validators + engine doctrine + 4-layer substrate
