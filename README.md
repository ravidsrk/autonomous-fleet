...
pytest tests/                                      # full suite (61 files, 1311 tests; 100% line coverage of the Python tooling, scripts/*.py — shell is validated by behavioral + mutation tests, not line coverage)
...
│   └── install-skills.sh
├── tests/                               # 61 test files, 1311 tests; validators + engine doctrine + 4-layer substrate
