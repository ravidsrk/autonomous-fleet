...
pytest tests/                                      # full suite (68 files, 1406 tests; 100% line coverage of the Python tooling, scripts/*.py — shell is validated by behavioral + mutation tests, not line coverage)
...
│   └── install-skills.sh
├── tests/                               # 68 test files, 1406 tests; validators + engine doctrine + 4-layer substrate
