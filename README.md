...
pytest tests/                                      # full suite (67 files, 1397 tests; 100% line coverage of the Python tooling, scripts/*.py — shell is validated by behavioral + mutation tests, not line coverage)
...
│   └── install-skills.sh
├── tests/                               # 67 test files, 1397 tests; validators + engine doctrine + 4-layer substrate
