...
pytest tests/                                      # full suite (60 files, 1270 tests; 100% line coverage of the Python tooling, scripts/*.py — shell is validated by behavioral + mutation tests, not line coverage)
...
│   └── install-skills.sh
├── tests/                               # 60 test files, 1270 tests; validators + engine doctrine + 4-layer substrate
