<!-- title: Safety and secrets | description: The threat model, the sandbox wrapper, --yolo, container-use placement, and secret hygiene rules for running autonomous-fleet on a repo you care about. | sidebar_order: 12 -->
