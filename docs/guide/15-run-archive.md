<!-- title: Run-archive anatomy | description: Every file inside a .fleet/runs/<id>/ directory, the manifest schema field-by-field, and the integrity gates that make a run replayable. | sidebar_order: 15 -->
