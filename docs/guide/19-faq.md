<!-- title: FAQ | description: Short answers to the ~30 questions people actually ask about autonomous-fleet: installation, choosing a mission, campaigns, safety, model support, cost, commercial use, and how it compares to other frameworks. | sidebar_order: 19 -->
