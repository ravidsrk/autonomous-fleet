<!-- title: Mission catalog | description: Every shipped autonomous-fleet mission: what it does, what it expects, what it produces, and how to run it, plus the exploratory roster and what each needs to ship. | sidebar_order: 9 -->
