---
title: "Missions vs campaigns"
description: "When to run one mission and when to chain several into a conditional campaign DAG"
sidebar:
  order: 5
---
...
`docs/exploratory/missions/archive/`. The [Mission catalog](/09-mission-catalog/) covers the
