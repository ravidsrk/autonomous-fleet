---
title: "Campaigns"
description: "Chain autonomous-fleet missions behind verification gates: the three shipped presets, writing a custom campaign YAML, dry-run planning, and the headless-mode caveat."
sidebar:
  order: 10
---
