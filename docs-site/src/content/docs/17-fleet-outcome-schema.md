---
title: "fleet-outcome schema"
description: "The machine-readable YAML block every mission emits at T-FINAL, field by field, and the campaign edge expressions that branch on it."
sidebar:
  order: 17
---
...
> churn. See the [Mission catalog](/09-mission-catalog/) for which are active today.
