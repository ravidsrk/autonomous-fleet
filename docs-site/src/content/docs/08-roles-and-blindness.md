---
title: "Roles and blindness"
description: "Why review in autonomous-fleet is structural, not instructed: the builder/reviewer/integrator topology, build-blindness, cross-vendor diversity, and the single-vendor trade-off."
sidebar:
  order: 8
---
